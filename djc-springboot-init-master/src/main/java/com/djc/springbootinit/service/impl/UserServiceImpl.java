...
import static com.djc.springbootinit.constant.UserConstant.USER_LOGIN_STATE;
...
import com.djc.springbootinit.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public TeacherVo getBindTeacher(User loginUser) {
        ...
        if (teacher != null) {
            ...
            teacherVo.setUserPhone(StringUtils.isBlank(teacher.getUserPhone()) ? "未填写" : teacher.getUserPhone());
